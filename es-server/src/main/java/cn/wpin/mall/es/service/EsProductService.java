...
import cn.wpin.mall.es.dao.EsProductDao;
import cn.wpin.mall.es.entity.EsProduct;
import cn.wpin.mall.es.entity.EsProductRelatedInfo;
import cn.wpin.mall.es.repository.EsProductRepository;
...
public class EsProductService {
    ...
    @Autowired
    private TestService kafkaService;

    @Autowired
    public EsProductService (@Lazy TestService kafkaService){
